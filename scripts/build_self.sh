...
#
# Layout produced:
#     out/<target>/<config>/odit_self(.exe)
...
case "$target" in
    windows) odin_target=windows_amd64 ; executable_name=odit_self.exe ;;
    linux)   odin_target=linux_amd64   ; executable_name=odit_self     ;;
    macos)   odin_target=darwin_arm64  ; executable_name=odit_self     ;;
